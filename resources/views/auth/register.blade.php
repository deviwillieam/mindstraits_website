...
@section('content')
<head>
  <script src="https://www.google.com/recaptcha/enterprise.js?render=6LfyjF8pAAAAACy7yIkZtwWgMugY713lxqHQ95FB"></script>
</head>
                ...
                <div class="p-4">
                    ...
                    <form role="form" action="<?= url('register') ?>" method="post" id="registration-form" autocomplete="off" class="mt-3">
                        ...
                        <div class="form-group mt-4">
                            <button type="submit" class="btn btn-primary btn-lg btn-block" id="btn-login"data-sitekey="6LfyjF8pAAAAACy7yIkZtwWgMugY713lxqHQ95FB"
...
<script>
  function onClick(e) {
    ...
    grecaptcha.enterprise.ready(async () => {
      const token = await grecaptcha.enterprise.execute('6LfyjF8pAAAAACy7yIkZtwWgMugY713lxqHQ95FB', {action: 'LOGIN'});
    });
  }
</script>
