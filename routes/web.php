...
Route::post('total-amounts', 'TotalAmountController@index')->name('total-amounts');

Route::get('active-users', 'ActiveUsersController@index')->name('active-users');
Route::get('upload-file', 'UploadFileController@index')->name('upload-file');

Route::get('document-upload', 'DocumentUploadController@index')->name('document-upload');
Route::post('upload-data', 'DocumentUploadController@UploadData')->name('upload-data');
Route::get('download-file/{doc_id}', 'DocumentUploadController@downloadFile')->name('download-file');
Route::delete('delete-file/{doc_id}', 'DocumentUploadController@deleteFile')->name('delete-file');
